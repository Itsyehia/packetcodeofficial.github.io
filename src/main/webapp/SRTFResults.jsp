...
<%
    ...
    List<SRTF> executedSJFList = (List<SRTF>) request.getAttribute("executedSJFList");
...
<div class="container">
    ...
    <div class="flex-container">
        ...
        <% for (SRTF srtf : executedSJFList) {%>
        <div class="results">   <%= srtf.name %>  <p class="bottom-left"> <%= srtf.executionTime %>  </p>
            <p class="results"> <%= srtf.turnaround %>  </p>
            <p class="results"> <%= srtf.timeWaiting %>  </p>

        </div>
        <% } %>

    </div>
    <h2>The average turnaround time is: <%= averageTurnAroundTime %></h2>
